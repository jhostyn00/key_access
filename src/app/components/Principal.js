  ...
  <div className="bg-gray-100 text-white p-6">
   ...
   <div className="mb-6 flex flex-wrap items-end gap-4">
    ...
    <div>
     ...
     <label className="block text-sm bg-gray-100 font-medium text-gray-300 mb-1">
    ...
    <div>
     ...
     <label className="block text-sm font-medium text-gray-300 mb-1 bg-gray-100">Filtrar por rol:</label>
